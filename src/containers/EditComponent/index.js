...
function SummerHtmlImageMapCreator() {
	...
	var get_image = (function() {
		...
		function onButtonClick(e) {
			app.loadImage(self.props.settings.landscapeImage);
	...
	var selected_area = app.getSelectedArea();
			...
			//save on localstorage when onsavebtnclick
	/////////
	...
	Rect.prototype.toString = function() { //to html map area code///yehudit
...
<form id="edit_details">
	...
	{/* <p>
  	...
  	<AutoComplete id="startup_name_attr"
...
<div id="get_image_wrapper">
	...
	<div id="get_image">
		...
		<button id="button" style={{display: (this.props.settings && this.props.settings.landscapeImage ? 'block' : 'none')}}>Continue with existing image</button>
		<b style={{display: (this.props.settings && this.props.settings.landscapeImage ? 'block' : 'none')}}>or</b>
